    ...
    render() {
        ...
        return (
            <div className="dev-section">
                ...
                <Button onClick={() => this.setState({ drawer1Visible: true })}>
                    drawer
                </Button>
                ...
                <Drawer
                    ...
                    style={{width: 600}}
                    onClose={() => this.setState({drawer1Visible: false})}>
                    <Drawer.Header
                        title="Right drawer"
                        onClose={() => this.setState({drawer1Visible: false})}/>

                    <Drawer.Body>
                        <p> The sages of Gulai are lonely </p>
                ...
                <Drawer
                    ...
                    onClose={() => this.setState({drawer2Visible: false})}>
                    <Drawer.Header
                        title="Right drawer"
                        onClose={() => this.setState({drawer1Visible: false})}/>
                    <Drawer.Body>
                ...
                <Drawer
                    ...
                    onClose={() => this.setState({drawer3Visible: false})}>
                    <Drawer.Header
                        title="Right drawer"
                        onClose={() => this.setState({drawer1Visible: false})}/>
                ...
                <Button onClick={() => this.setState({drawer4Visible: true})}>
                    drawer - bottom
                </Button>

                <Drawer
                    placement="bottom"
                    visible={drawer4Visible}
                    onClose={() => this.setState({ drawer4Visible: false})}/>
            </div>
        );
    }
}
