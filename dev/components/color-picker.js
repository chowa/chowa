    ...
    render() {
        return (
            <div className='dev-section'>
                ...
                <ColorPicker alpha recommend={['#311B92', '#512DA8', '#673AB7', '#9575CD', '#D1C4E9', '#ff0', '#f00', '#123eda', '#eee', '#ddd', '#333', '#444', '#555', '#999']}/>

                <br/>

                <ColorSaturation value={{h: 326, s: 84, b: 60}}/>

                <ColorHue value={{h: 326, s: 84, b: 60}}/>

                <ColorAdjustment mode='hsl' alpha recommend={['#311B92', '#512DA8', '#673AB7', '#9575CD', '#D1C4E9', '#ff0', '#f00', '#123eda', '#eee', '#ddd', '#333', '#444', '#555', '#999']}/>
