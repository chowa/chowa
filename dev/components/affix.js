    ...
    render() {
        return (
            <div className='dev-section'>
                ...
                {/*<Affix><button>test</button></Affix>
                ...
                <div style={{height: 100, overflowY: 'scroll', background: '#f00'}} ref={(ele) => {
                    ...
                    <div style={{height: 800, position: 'relative'}}>
                        <Affix target={() => {
                            ...
                            <div style={{zIndex: 100, background: '#7774e7', fontSize: 14, color: '#fff'}}>固定在顶部</div>
                        </Affix>
                    </div>
                </div>
                ...
                <div style={{height: 100, overflowY: 'scroll', background: '#f00', position: 'relative'}} ref={(ele) => {
                    ...
                    <div style={{height: 800, position: 'relative'}}>
                        ...
                        <Affix target={() => {
                            ...
                            <div style={{zIndex: 100, background: '#7774e7', fontSize: 14, color: '#fff'}}>固定在底部</div>
                        </Affix>
                    </div>
                </div>
                ...
                <Affix offsetBottom={20} onChange={affixed => console.log(affixed)}><button>bottom</button></Affix>
            </div>
        );
    }
}
