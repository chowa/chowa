    ...
    render() {
        ...
        return (
            ...
            <Grid.Row style={wrapStyle}>
                <Grid.Col span={8} style={oddStyle}></Grid.Col>
                <Grid.Col span={8} style={evenStyle}></Grid.Col>
                <Grid.Col span={8} style={oddStyle}></Grid.Col>
            </Grid.Row>

            {/*<Grid.Row style={wrapStyle}>
                    <Grid.Col span={6} style={oddStyle}></Grid.Col>
                    <Grid.Col span={12} push={6} style={evenStyle}></Grid.Col>
                </Grid.Row>

                <Grid.Row align='middle' style={wrapStyle} className='cw-mt-18'>
                    <Grid.Col span={6} style={oddStyle}></Grid.Col>
                    <Grid.Col span={12} push={1} style={evenStyle}></Grid.Col>
                </Grid.Row>
                ...
                <Grid.Row justify='center' style={wrapStyle} className='cw-mt-18'>
                    <Grid.Col span={6} style={oddStyle}></Grid.Col>
                    <Grid.Col span={12} push={1} style={evenStyle}></Grid.Col>
                </Grid.Row>

                <Grid.Row justify='space-between' style={wrapStyle} className='cw-mt-18'>
                    <Grid.Col span={6} style={oddStyle}></Grid.Col>
                    <Grid.Col span={12} push={1} style={evenStyle}></Grid.Col>
                </Grid.Row>

                <Grid.Row gutter={20} style={wrapStyle} className='cw-mt-18'>
                    <Grid.Col span={12}><div style={oddStyle}></div></Grid.Col>
                    <Grid.Col span={12}><div style={evenStyle}></div></Grid.Col>
                </Grid.Row>

                <Grid.Row className='cw-mt-18'>
                    <Grid.Col order={4} span={6}><div style={oddStyle}></div></Grid.Col>
                    <Grid.Col order={3} span={6}><div style={evenStyle}></div></Grid.Col>
                    <Grid.Col order={2} span={6}><div style={oddStyle}></div></Grid.Col>
                    <Grid.Col order={1} span={6}><div style={evenStyle}></div></Grid.Col>
                </Grid.Row>*/}
            </div>
        );
    }
