    ...
    render() {
        ...
        return (
            <div className="dev-section">
                ...
                <Input size="small" addonBefore="Beijing" />

                <Input size="large" addonBefore="Beijing" />

                <Input prefix={<Icon type="calendar" />} addonAfter="张三 收" />
                ...
                <Input
                    ...
                    value={search}
                    onPressEnter={this.searchTreeNode}
                    clearable/>
            </div>
        );
    }
